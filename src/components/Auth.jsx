  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.data.detail === "OTP sent successfully") {
        // Handle successful OTP send - you can add navigation or state management here
                        ...
                        <div x-data="{ checkboxToggle: false }">
                          ...
                          >
                            <div className="relative">
                              ...
                              />
                              <div
                                className="checkboxToggle ? 'border-brand-500 bg-brand-500' : 'bg-transparent border-gray-300 dark:border-gray-700'"
                                className="mr-3 flex h-5 w-5 items-center justify-center rounded-md border-[1.25px] bg-transparent border-gray-300 dark:border-gray-700"
                              >
